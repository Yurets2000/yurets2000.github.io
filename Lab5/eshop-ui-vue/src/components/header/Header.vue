        ...
        <div class="market-nav-container">
          <div class="market-nav">
            <div class="searchbar-container">
              <div class="searchbar">
                <input type="text" class="searchbar-text" placeholder="Search">
...
export default {
  ...
  methods: {
    ...
    getTotalPrice() {
      ...
      console.log(JSON.stringify('getTotalPrice, user: ' + JSON.stringify(user)));
    ...
    getTotalCount() {
      const user = this.$store.state.user;
      console.log(JSON.stringify('getTotalCount, user: ' + JSON.stringify(user)));
