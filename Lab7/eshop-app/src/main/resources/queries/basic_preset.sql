...
--Markets
INSERT INTO public.markets(id, description, name, latitude, longitude)
VALUES ('2bcbbaa8-6d56-4e40-ae69-52e76c9158d8', null, 'Market #1', 50.450, 30.520);
INSERT INTO public.markets(id, description, name, latitude, longitude)
VALUES ('3a588368-a4f7-43da-9e29-35a311203bb6', null, 'Market #2', 50.430, 30.530);
INSERT INTO public.markets(id, description, name, latitude, longitude)
VALUES ('5ca1d2d9-5010-4195-9c0d-bf04642143e3', null, 'Market #3', 50.370, 30.370);
INSERT INTO public.markets(id, description, name, latitude, longitude)
VALUES ('fdaff1ef-6daf-4c18-8fb5-c89a73a8a5af', null, 'Market #4', 50.385, 30.485);
INSERT INTO public.markets(id, description, name, latitude, longitude)
VALUES ('bd328db3-cecf-4efe-b673-ec6c42c7c30e', null, 'Market #5', 50.395, 30.442);
INSERT INTO public.markets(id, description, name, latitude, longitude)
VALUES ('8e0dad15-3992-4eec-9dd0-a4eed0b47e27', null, 'Market #6', 50.396, 30.338);
INSERT INTO public.markets(id, description, name, latitude, longitude)
VALUES ('0f4eae0f-3145-4177-a0ab-0226f6c4a5a4', null, 'Market #7', 50.407, 30.303);
INSERT INTO public.markets(id, description, name, latitude, longitude)
VALUES ('b8a04f83-682e-456d-8a0d-b44323f33195', null, 'Market #8', 50.980, 30.313);
INSERT INTO public.markets(id, description, name, latitude, longitude)
VALUES ('995ada0f-e82c-4b30-a96b-05c19b7babcc', null, 'Market #9', 50.502, 30.325);
INSERT INTO public.markets(id, description, name, latitude, longitude)
VALUES ('25017100-2356-4a8e-b71d-0668a8f6099a', null, 'Market #10', 50.410, 30.302);


--Banners
INSERT INTO public.banners(id, image_url)
VALUES ('8230cd22-5365-4ace-b4d0-5b65c6e95820', 'https://i.ibb.co/gvtNrjN/banner-1.jpg');
INSERT INTO public.banners(id, image_url)
VALUES ('17e35ab0-e69b-4ef4-a019-78fe37a9f0c3', 'https://i.ibb.co/hsg1p5c/banner-2.jpg');
INSERT INTO public.banners(id, image_url)
VALUES ('1cdb7d2a-0861-4474-9b19-fa676e75e3f1', 'https://i.ibb.co/2nJ3fSc/banner-3.jpg');
INSERT INTO public.banners(id, image_url)
VALUES ('1bec23f0-78a6-4ff0-ad24-481b009eef93', 'https://i.ibb.co/d75xqWQ/banner-4.jpg');
INSERT INTO public.banners(id, image_url)
VALUES ('35df6c79-95d2-48d0-b95e-86306f0dce85', 'https://i.ibb.co/kh61r0h/banner-5.jpg');
INSERT INTO public.banners(id, image_url)
VALUES ('b27e874c-9a39-4182-9ad1-96e4719fd4c8', 'https://i.ibb.co/bBfYzs3/banner-6.jpg');
